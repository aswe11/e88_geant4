...
#ifndef E16G4_RPCSD_hh
#define E16G4_RPCSD_hh
...
class E16G4_RPCSD : public G4VSensitiveDetector {
public:
   E16G4_RPCSD(const G4String &name, const E16ANA_GeometryV2 *geom);
   ~E16G4_RPCSD();
