...
#ifndef E16G4_VDCylinder_h
#define E16G4_VDCylinder_h 1
...
class E16G4_VDCylinder : public E16G4_BeamLineElement
{
   private:
      G4String elemname_;
   ...
   public:
   E16G4_VDCylinder( const G4String &name,
