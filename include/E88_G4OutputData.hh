...
class E88_G4RunHeader{
public:
  int WriteData(FILE* fp){
    return fwrite(this, sizeof(E88_G4RunHeader),1,fp);
  }
  int ReadData(FILE* fp){
    return fread(this, sizeof(E88_G4RunHeader),1,fp);
  }
private:
...
public:
  ...
  int WriteData(FILE* fp){
    return fwrite(this, sizeof(E88_G4EventHeader),1,fp);
  }
  int ReadData(FILE* fp){
    int n =  fread(this, sizeof(E88_G4EventHeader),1,fp);
  ...
  */
  ...
  void Dump(std::string tag=""){
    fprintf(stderr, 
	    "E88_EventHeader: version=%3i : %s : evG4 evJAM M overlap = %5i %5i %5i %5i\n",
...
public:
  ...
  E88_G4BitFlag* HitFlag(){return &bitflag;}
  ...
  int WriteData(FILE* fp){
    return fwrite(this, sizeof(E88_G4Trajectory),1,fp);
  }
  int ReadData(FILE* fp){
    return fread(this, sizeof(E88_G4Trajectory),1,fp);
  }
  ...
  void Dump(std::string tag=""){
    fprintf(stderr, 
	    "E88_G4Trajectory: %s : %5i %6.1f %6.1f %6.1f / %6.2f %6.2f %6.2f:%6.2f/ %6.1f %6i %6i %s %s %s\n",
...
public:
  ...
  void SetT(double it){t=it;}
  int WriteData(FILE* fp){
    return fwrite(this, sizeof(E88_G4Track),1,fp);
  }
  int ReadData(FILE* fp){
    return fread(this, sizeof(E88_G4Track),1,fp);
  }
  int TrackID(){return trackID;}
  int EventID(){return eventID;}
  void EventIDputOffset(int offset){eventID += offset;}
  ...
  void Dump(std::string tag=""){
    fprintf(stderr, 
	    "E88_G4Track: %s : %5i %6.1f %6.1f %6.1f / %6.2f %6.2f %6.2f:%6.2f/ %6.1f %6i %6i %s\n",
	    tag.c_str(), eventID, x, y, z, px, py, pz, p, t, trackID, pID,
...
public:
  ...
  void Dump(std::string tag=""){
    fprintf(stderr, 
	    "E88_G4Hit: %s : %6.1f %6.1f %6.1f /%6.3f %6.3f %6.3f\n",
...
#if 0
  int WriteData(FILE* fp){
    return fwrite(this, sizeof(E88_G4Hit),1,fp);
  }
  int ReadData(FILE* fp){
    return fread(this, sizeof(E88_G4Hit),1,fp);
  }
#endif
  void Dump(std::string tag=""){
    fprintf(stderr, 
	    "E88_G4Hit: %s : %6.1f %6.1f %6.1f /%6.1f %6.1f %6.1f %6i\n",
...
template <class T> class E88_G4Detector{ 
...
public:
  ...
  int ReadData(FILE* fp){
    //printf("E88_G4OutputData.hh ReadData noh L292 before fread %d\n",noh);
  ...
  int HitsAppend(double timeoffset, E88_G4Detector& det2, 
		 int eventIDoffset = 0){
...
class E88_G4Event{
  //  List of track & hit
private:
  E88_G4EventHeader eventHeader;
  E88_G4Detector<E88_G4Track> primaryTracks;

  E88_G4Detector<E88_G4Trajectory> primaryTrajectories;
  E88_G4Detector<E88_G4Trajectory> secondaryTrajectories;
  std::vector<E88_G4Trajectory*> allTrajectories;

  E88_G4Detector<E88_G4Hit> target1;
  E88_G4Detector<E88_G4Hit> target2;
  E88_G4Detector<E88_G4Hit> target3;
  E88_G4Detector<E88_G4Hit> target4;
  E88_G4Detector<E88_G4Hit> target5;
  E88_G4Detector<E88_G4Hit> ssd;
  E88_G4Detector<E88_G4Hit> gtr1;
  E88_G4Detector<E88_G4Hit> gtr2;
  E88_G4Detector<E88_G4Hit> gtr3;
  E88_G4Detector<E88_G4Hit> hbd;
  //sako
  E88_G4Detector<E88_G4Hit> rpc;
  E88_G4Detector<E88_G4Hit> lg;
  E88_G4Detector<E88_G4Hit> lgvd;
  E88_G4Detector<E88_G4Hit> gtrframe1;
  E88_G4Detector<E88_G4Hit> gtrframe2;
  E88_G4Detector<E88_G4Hit> gtrframe3;
  E88_G4Detector<E88_G4Hit> vd1;          //virtual detector
  E88_G4Detector<E88_G4Hit> vdcyl1;       //virtual detector/cylindrical
  E88_G4Detector<E88_G4Hit> vdcyl2;
  E88_G4Detector<E88_G4Hit> vdcyl3;
  E88_G4Detector<E88_G4Hit> vdcyl4;

  E88_G4Detector<E88_G4Hit>* targets[5];
  E88_G4Detector<E88_G4Hit>* gtrs[3];
  E88_G4Detector<E88_G4Hit>* gtrframes[3];
  E88_G4Detector<E88_G4Hit>* vdcyls[4];
...
public:
  ...
  */
  ...
  int EventAppend(double timeoffset,  E88_G4Event& ev2, 
		  int eventIDoffset = 0);
  ...
  //accesser
  E88_G4Track&  PrimaryTracks(int i){
    return primaryTracks.Hit(i);};
  E88_G4Detector<E88_G4Track>&  PrimaryTracks(){
    return primaryTracks;
  };

  E88_G4Trajectory&  PrimaryTrajectory(int i){
    return primaryTrajectories.Hit(i);};
  E88_G4Detector<E88_G4Trajectory>&  PrimaryTrajectories(){
    return primaryTrajectories;
  };
  E88_G4Trajectory&  SecondaryTrajectory(int i){
    return secondaryTrajectories.Hit(i);};
  E88_G4Detector<E88_G4Trajectory>&  SecondaryTrajectories(){
    return secondaryTrajectories;
  };
  E88_G4Trajectory*  AllTrajectory(int i){
    return allTrajectories[i];};
  std::vector<E88_G4Trajectory*>&  AllTrajectories(){
    return allTrajectories;
  };

  E88_G4Detector<E88_G4Hit>&  TARGET(int i){return *(targets[i]);};
  E88_G4Detector<E88_G4Hit>&  SSD(){return ssd;};
  //sako
  E88_G4Detector<E88_G4Hit>&  RPC(){return rpc;};
  E88_G4Detector<E88_G4Hit>&  GTR1(){return gtr1;};
  E88_G4Detector<E88_G4Hit>&  GTR2(){return gtr2;};
  E88_G4Detector<E88_G4Hit>&  GTR3(){return gtr3;};
  E88_G4Detector<E88_G4Hit>&  GTRs(int i){return *(gtrs[i]);};
  E88_G4Detector<E88_G4Hit>&  HBD(){return hbd;};
  E88_G4Detector<E88_G4Hit>&  LG(){return lg;};
  E88_G4Detector<E88_G4Hit>&  LGVD(){return lgvd;};
  E88_G4Detector<E88_G4Hit>&  GTRFrame1(){return gtrframe1;};
  E88_G4Detector<E88_G4Hit>&  GTRFrame2(){return gtrframe2;};
  E88_G4Detector<E88_G4Hit>&  GTRFrame3(){return gtrframe3;};
  E88_G4Detector<E88_G4Hit>&  GTRFrames(int i){return *(gtrframes[i]);};
  E88_G4Detector<E88_G4Hit>&  VD1(){return vd1;};
  E88_G4Detector<E88_G4Hit>&  VDCyl1(){return vdcyl1;};
  E88_G4Detector<E88_G4Hit>&  VDCyl2(){return vdcyl2;};
  E88_G4Detector<E88_G4Hit>&  VDCyl3(){return vdcyl3;};
  E88_G4Detector<E88_G4Hit>&  VDCyl4(){return vdcyl4;};
  E88_G4Detector<E88_G4Hit>&  VDCylinders(int i){return *(vdcyls[i]);};
  
};

//----------------------------------------------
class E88_G4OutputData{
public:
  E88_G4OutputData();
  ~E88_G4OutputData();
...
private:
  FILE* fpRead;
  FILE* fpWrite;
  E88_G4Event  event;            //handle for current event in the data file
  E88_G4Event* overlapEvent;     //handle for the overlapped event
  E88_G4RunHeader run;
...
public:
  ...
  E88_G4RunHeader& RunData(){ return run;}

  E88_G4Event& Event(){ return event;}
  E88_G4Event& OverlapEvent(){ return *overlapEvent;}
...
class E88_G4ModuleHitList{ 
  // E88_G4Event -> vector, by-module, by-chamber
  //independent on E88_G4Event,  in order to avoid 
  //changing the file-IO structure

  //lpos, lmom, t
  //  vector<E88_G4Hit>  gtr1List;
private:
  ...
  std::vector<E88_G4Hit>  ssdList[NmoduleSSD];
  //sako
  std::vector<E88_G4Hit>  rpcList[NmoduleRPC];
  std::vector<E88_G4Hit>  gtr1List[33];
  std::vector<E88_G4Hit>  gtr2List[33];
  std::vector<E88_G4Hit>  gtr3List[33];

  std::vector<E88_G4Hit>* gtr[3];
  void SetG4Event(E88_G4Event& g4event);

  std::vector<E88_G4Hit>  hbdList[33];
  std::vector<E88_G4Hit>  lgvdList[33];

public:

  E88_G4ModuleHitList(E88_G4Event& g4event){
  ...
  std::vector<E88_G4Hit>& SSDModule(int moduleID){
    return ssdList[moduleID];
  }
  //sako
  std::vector<E88_G4Hit>& RPCModule(int moduleID){
    return rpcList[moduleID];
  }

  std::vector<E88_G4Hit>& GTR1Module(int moduleID){
    return gtr1List[moduleID];}
  std::vector<E88_G4Hit>& GTR2Module(int moduleID){
    return gtr2List[moduleID];}
  std::vector<E88_G4Hit>& GTR3Module(int moduleID){
    return gtr3List[moduleID];}
  std::vector<E88_G4Hit>& HBDModule(int moduleID){
    return hbdList[moduleID];}
  std::vector<E88_G4Hit>& LGVDModule(int moduleID){
    return lgvdList[moduleID];}

  std::vector<E88_G4Hit>& GTRModule(int layerID, int moduleID){
...
public:
  ...
  // SSD
  static void InsertSingleRateBKG_SSD(int moduleID, std::vector<E88_G4Hit>& hits, int is_forward, double halo_angle);
  static void InsertSingleRateBKG_SSD(int flag, int moduleID, double rate, double size, std::vector<E88_G4Hit>& hits, const TVector3 &halo_direction = TVector3(0,0,0));
  static void InsertSingleRateBKGHalo_SSD(int moduleID, double rate_halo, double size, std::vector<E88_G4Hit>& hits, const TVector3 &halo_direction){
     int flag = 1;
     InsertSingleRateBKG_SSD(flag, moduleID, rate_halo, size, hits, halo_direction);
  };
  static void InsertSingleRateBKGRandom_SSD(int moduleID, double rate_bkg, double size, std::vector<E88_G4Hit>& hits){
     int flag = 0;
     InsertSingleRateBKG_SSD(flag, moduleID, rate_bkg, size, hits);
  };

  //in order to use the old set
  //, in E88_G4ModuleHitList::OverlapGTRSingleHits151201();
