...
//E16G4_TargetHit.hh 150105
//    Last modified at <2015-01-05 14:11:12 >
//

#ifndef E16G4_TAREGT_HIT_H
#define E16G4_TARGET_HIT_H
...
class E16G4_TargetHit : public G4VHit{
   private:
   ...
   public:
      E16G4_TargetHit();
      E16G4_TargetHit(G4ThreeVector& axyz, G4double t, G4double acharge);
      virtual ~E16G4_TargetHit();

      E16G4_TargetHit(const E16G4_TargetHit& right);
      const E16G4_TargetHit& operator=(const E16G4_TargetHit& right);
...
inline E16G4_TargetHit::E16G4_TargetHit(const E16G4_TargetHit& right)
   : G4VHit(){
      xyz_= right.xyz_;
      time_= right.time_;
...
inline const E16G4_TargetHit& E16G4_TargetHit::operator=(const E16G4_TargetHit& right){
   xyz_= right.xyz_;
   time_= right.time_;
   charge_= right.charge_;
   return *this;
...
typedef G4THitsCollection<E16G4_TargetHit> TargetHitsCollection;
extern G4Allocator<E16G4_TargetHit> TargetHitAllocator;

inline void* E16G4_TargetHit::operator new(size_t){
   void* aHit= (void*)TargetHitAllocator.MallocSingle();
   return aHit;
}

inline void E16G4_TargetHit::operator delete(void* aHit){
   TargetHitAllocator.FreeSingle((E16G4_TargetHit*) aHit);
}

#endif//E16G4_TAREGT_HIT_H
