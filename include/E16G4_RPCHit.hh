...
#ifndef E16G4_RPCHit_hh
#define E16G4_RPCHit_hh
...
class E16G4_RPCHit : public G4VHit{
private:
...
public:
   E16G4_RPCHit();
   E16G4_RPCHit(const G4ThreeVector& axyz, G4double t, G4double acharge);
   virtual ~E16G4_RPCHit();

   E16G4_RPCHit(const E16G4_RPCHit& right);
   const E16G4_RPCHit& operator=(const E16G4_RPCHit& right);
...
inline E16G4_RPCHit::E16G4_RPCHit(const E16G4_RPCHit& right)
   : G4VHit(){
      xyz_= right.xyz_;
      time_= right.time_;
...
inline const E16G4_RPCHit& E16G4_RPCHit::operator=(const E16G4_RPCHit& right){
   xyz_= right.xyz_;
   time_= right.time_;
   charge_= right.charge_;
   return *this;
...
typedef G4THitsCollection<E16G4_RPCHit> RPCHitsCollection;

extern G4Allocator<E16G4_RPCHit> RPCHitAllocator;

inline void* E16G4_RPCHit::operator new(size_t){
   void* aHit= (void*)RPCHitAllocator.MallocSingle();
   return aHit;
}

inline void E16G4_RPCHit::operator delete(void* aHit){
   RPCHitAllocator.FreeSingle((E16G4_RPCHit*) aHit);
}

#endif // E16G4_RPCHit_hh
