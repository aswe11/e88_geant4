...
/*
  E16G4_GTRFrameHit.hh

  D.Kawama
*/

#ifndef E16G4_GTRFrameHit_h

#define E16G4_GTRFrameHit_h 1
...
class E16G4_GTRFrameHit : public G4VHit
{
public:
  E16G4_GTRFrameHit( G4int id, const G4ThreeVector &gPos, const G4ThreeVector &gMom,
	    G4double edep, 
...
private:
  E16G4_GTRFrameHit( const E16G4_GTRFrameHit &  );
  E16G4_GTRFrameHit & operator = ( const E16G4_GTRFrameHit & );

public:
  int operator == ( const E16G4_GTRFrameHit & ) const
  { return 0; }
...
typedef G4THitsCollection<E16G4_GTRFrameHit> GTRFrameHitsCollection;

extern G4Allocator<E16G4_GTRFrameHit> GTRFrameHitAllocator;

inline void* E16G4_GTRFrameHit::operator new( size_t )
{
   return static_cast<void*>( GTRFrameHitAllocator.MallocSingle() );
}

inline void E16G4_GTRFrameHit::operator delete( void* aHit )
{
   GTRFrameHitAllocator.FreeSingle
      ( static_cast<E16G4_GTRFrameHit *>( aHit ) );
}

#endif//E16G4_GTRFrameHit_h
