...
E16G4_PhysicsList::E16G4_PhysicsList() : G4VModularPhysicsList()
{
  ...
  //pMessenger = new E16G4_PhysicsListMessenger(this);
...
E16G4_PhysicsList::~E16G4_PhysicsList()
{
  //delete pMessenger;
  delete particleList;
...
void E16G4_PhysicsList::ConstructParticle()
{
...
void E16G4_PhysicsList::ConstructProcess()
{
  AddTransportation();
...
void E16G4_PhysicsList::AddPhysicsList(const G4String& name)
{
  if (verboseLevel>0) {
  ...
  if (name == "emstandard_opt2") {
    ...
    G4cout << "E16G4_PhysicsList::AddPhysicsList: <" << name << ">"
           << " is not defined"
           << G4endl;
  }
}
...
void E16G4_PhysicsList::SetBuilderList0(G4bool flagHP)
{
...
void E16G4_PhysicsList::SetBuilderList1(G4bool flagHP)
{
  hadronPhys.push_back( new G4EmExtraPhysics(verboseLevel));
  if(flagHP) {
    hadronPhys.push_back( new G4HadronElasticPhysicsHP(verboseLevel) );
...
void E16G4_PhysicsList::SetBuilderList2(G4bool addStopping)
{
  hadronPhys.push_back( new G4EmExtraPhysics(verboseLevel));
...
void E16G4_PhysicsList::SetBuilderList3()
{
  hadronPhys.push_back( new G4EmExtraPhysics(verboseLevel));
...
void E16G4_PhysicsList::SetBuilderList4()
{
  hadronPhys.push_back( new G4EmExtraPhysics(verboseLevel));
...
void E16G4_PhysicsList::SetCuts()
{
...
void E16G4_PhysicsList::SetCutForGamma(G4double cut)
{
  cutForGamma = cut;
...
void E16G4_PhysicsList::SetCutForElectron(G4double cut)
{
  cutForElectron = cut;
...
void E16G4_PhysicsList::SetCutForPositron(G4double cut)
{
  cutForPositron = cut;
...
void E16G4_PhysicsList::SetCutForProton(G4double cut)
{
  cutForProton = cut;
  SetParticleCuts(cutForProton, G4Proton::Proton());
}

void E16G4_PhysicsList::List()
{
