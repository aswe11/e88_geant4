...
#ifndef E16G4_VDHit_h
#define E16G4_VDHit_h 1
...
class E16G4_VDHit : public G4VHit
{
public:
  E16G4_VDHit( G4int id, const G4ThreeVector &gPos, const G4ThreeVector &gMom,
	    G4double edep, 
...
private:
  E16G4_VDHit( const E16G4_VDHit &  );
  E16G4_VDHit & operator = ( const E16G4_VDHit & );

public:
  int operator == ( const E16G4_VDHit & ) const
  { return 0; }
...
typedef G4THitsCollection<E16G4_VDHit> VDHitsCollection;

extern G4Allocator<E16G4_VDHit> VDHitAllocator;

inline void* E16G4_VDHit::operator new( size_t )
{
   return static_cast<void*>( VDHitAllocator.MallocSingle() );
}

inline void E16G4_VDHit::operator delete( void* aHit )
{
   VDHitAllocator.FreeSingle
      ( static_cast<E16G4_VDHit *>( aHit ) );
}
