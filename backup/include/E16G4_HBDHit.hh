...
//E16G4_HBDHit.hh 150105 
//    Last modified at <2015-01-05 14:04:22 >
//
#ifndef E16G4_HBD_HIT_HH
#define E16G4_HBD_HIT_HH
...
class E16G4_HBDHit : public G4VHit{
   private:
      G4int ID_, segID_, trackID_, PDGCode_;
      G4ThreeVector xyz_;
   ...
   public:
      E16G4_HBDHit();
      E16G4_HBDHit(G4ThreeVector& axyz, G4double t, G4double acharge);
      virtual ~E16G4_HBDHit();

      E16G4_HBDHit(const E16G4_HBDHit& right);
      const E16G4_HBDHit& operator=(const E16G4_HBDHit& right);
...
inline E16G4_HBDHit::E16G4_HBDHit(const E16G4_HBDHit& right)
   : G4VHit(){
      xyz_= right.xyz_;
      time_= right.time_;
...
inline const E16G4_HBDHit& E16G4_HBDHit::operator=(const E16G4_HBDHit& right){
   xyz_= right.xyz_;
   time_= right.time_;
   charge_= right.charge_;
   return *this;
...
typedef G4THitsCollection<E16G4_HBDHit> HBDHitsCollection;

extern G4Allocator<E16G4_HBDHit> HBDHitAllocator;

inline void* E16G4_HBDHit::operator new(size_t){
   void* aHit= (void*)HBDHitAllocator.MallocSingle();
   return aHit;
}

inline void E16G4_HBDHit::operator delete(void* aHit){
   HBDHitAllocator.FreeSingle((E16G4_HBDHit*) aHit);
}

#endif//E16G4_HBD_HIT_HH
