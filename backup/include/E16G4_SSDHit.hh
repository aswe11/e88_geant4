...
#ifndef E16G4_SSDHit_hh
#define E16G4_SSDHit_hh
...
class E16G4_SSDHit : public G4VHit{
private:
...
public:
   E16G4_SSDHit();
   E16G4_SSDHit(const G4ThreeVector& axyz, G4double t, G4double acharge);
   virtual ~E16G4_SSDHit();

   E16G4_SSDHit(const E16G4_SSDHit& right);
   const E16G4_SSDHit& operator=(const E16G4_SSDHit& right);
...
inline E16G4_SSDHit::E16G4_SSDHit(const E16G4_SSDHit& right)
   : G4VHit(){
      xyz_= right.xyz_;
      time_= right.time_;
...
inline const E16G4_SSDHit& E16G4_SSDHit::operator=(const E16G4_SSDHit& right){
   xyz_= right.xyz_;
   time_= right.time_;
   charge_= right.charge_;
   return *this;
...
typedef G4THitsCollection<E16G4_SSDHit> SSDHitsCollection;

extern G4Allocator<E16G4_SSDHit> SSDHitAllocator;

inline void* E16G4_SSDHit::operator new(size_t){
   void* aHit= (void*)SSDHitAllocator.MallocSingle();
   return aHit;
}

inline void E16G4_SSDHit::operator delete(void* aHit){
   SSDHitAllocator.FreeSingle((E16G4_SSDHit*) aHit);
}

#endif // E16G4_SSDHit_hh
