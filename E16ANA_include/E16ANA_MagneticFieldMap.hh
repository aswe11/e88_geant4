...
public:
  enum{ ERROR = -9999};
  virtual bool GetFieldValue( const double point[3], double *Bfield, int bcflag ) const =0;
  ...
  virtual int Initialize_Bz( double field);
};
...
public:
 ...
 //yok
  ...
  int Convert( char* writefilename);
...
class E16ANA_MagneticFieldConstBz : public E16ANA_MagneticFieldMap
{
private:
  double Bz;//gauss
public:
  E16ANA_MagneticFieldConstBz(double field):Bz(field){}
  ~E16ANA_MagneticFieldConstBz() {}

public:

  int Initialize_Bz( double field){ Bz = field; return 0;}

  bool GetFieldValue( const double point[3], double *Bfield, int bcflag ) 
    const {
    Bfield[0]=0;  Bfield[1]=0;  Bfield[2]=Bz;
    return true;
  }
