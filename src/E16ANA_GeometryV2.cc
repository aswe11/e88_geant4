...
//sako
const std::string E16ANA_GeometryV2::rpc_str     = "RPC";
...
void E16ANA_GeometryV2::SetValuesFromV1(E16ANA_GeometryV1 *geom_v1){
  ...
  G4cout << "%%%%% E16ANA_GeometryV2::SetValuesFromV1(E16ANA_GeometryV1 called" << G4endl;
  exit(-1);
   params.clear();
   geometry_tree->Reset();
...
//sako
std::string E16ANA_GeometryV2::GetTreeStringRPC(int frame){
   return e16_str+delimiter
      +rpc_str+delimiter
      +GetNumString(frame_str, frame);
}

std::string E16ANA_GeometryV2::GetTreeStringRPC(int frame, int module){
